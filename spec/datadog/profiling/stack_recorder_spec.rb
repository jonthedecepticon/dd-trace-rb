    ...
    describe "heap samples and sizes" do
      ...
      context "when enabled" do
        ...
        it "records correct stack traces" do
          ...
          unique_line1 = stack1.find { |it| it.base_label.end_with?('#introduce_distinct_stacktraces') }
          unique_line2 = stack2.find { |it| it.base_label.end_with?('#introduce_distinct_stacktraces') }
